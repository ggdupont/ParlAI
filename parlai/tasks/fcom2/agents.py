...
class IndexTeacher(FixedDialogTeacher):
    """Hand-written SQuAD teacher adapted from the SQuAD2 to fcom2.
    ...
    def __init__(self, opt, shared=None):
        ...
        if self.datatype.startswith('train'):
            ...
            suffix = 'dev'
        datapath = os.path.join(opt['datapath'], 'fcom2', suffix + '-v{}.json'.format(IndexTeacher.version))
...
class DefaultTeacher(DialogTeacher):
    ...
    def __init__(self, opt, shared=None):
        ...
        if opt['datatype'].startswith('train'):
            ...
            suffix = 'dev'
        opt['datafile'] = os.path.join(opt['datapath'], 'fcom2', suffix + '-v{}.json'.format(IndexTeacher.version))
        self.id = 'fcom2'
        super().__init__(opt, shared)
